...
import { RegisterPageProps } from "../../lib/type/auth";

export default function RegisterPageView({ state, actions }: RegisterPageProps) {
    const handleSubmit = async (values: any, formikActions: FormikHelpers<any>) => {
    ...
    /* ---------------------------------- utils --------------------------------- */
    const getProgress = (values: any, errors: any, touched: any) => {
                                ...
                                >
                                    <Stack spacing={3} width="100%">
                                        ...
                                        <Stack spacing={2} mt={3} alignItems="center">
                                            <StyledFadeButton type="submit" variant="contained" disabled={state.isLoading}>
                                                Register
                                            </StyledFadeButton>

                                            <StyledWhiteButton variant="outlined" onClick={actions.navigateToLogin}>
                                                Login
                                            </StyledWhiteButton>
                                        </Stack>
                                    </Stack>
