...
import { LoginPageProps } from "../../lib/type/auth";

export default function LoginPageView({ state, actions }: LoginPageProps) {
                        ...
                        >
                            <Stack spacing={3}>
                                ...
                                <Stack spacing={2} mt={10} alignItems="center">
                                    ...
                                    <StyledWhiteButton variant="outlined" onClick={actions.navigateToRegister}>
                                        Register
                                    </StyledWhiteButton>
                                </Stack>
                            </Stack>
